-- Fix check_subscription_completion function to exclude trial sessions
...
BEGIN
  -- Count sessions for student (excluding trial sessions - session_number = 1)
  SELECT 
    COUNT(*) as total,
  ...
  WHERE ss.student_id = p_student_id
    AND s.session_number > 1;  -- Exclude trial sessions
